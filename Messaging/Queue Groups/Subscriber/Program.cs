...
// キューグループに参加
var queueGroupName = "task_workers"; // グループ名を指定

var cts = new CancellationTokenSource();
var subscriptionTask = Task.Run(async () =>
{
    await foreach (var msg in nc.SubscribeAsync<Order>(subject:subject, queueGroup: queueGroupName, cancellationToken: cts.Token))
    {
        var order = msg.Data;
